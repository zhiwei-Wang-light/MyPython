# Created by wzw 2023-09-08
# 蒙特卡洛方法训练policy gradient
# policy gradient只能做回合制，也就是policy gradient
# 回合更新
# on-policy
# 技巧1:不使用平均奖励，使用动作执行后影响到的奖励，距离当前动作越远受到的奖励权重越小
# 技巧2:减去奖励的均值
# 优点：
...
class PG(object):
    ...
    def choose_action(self, observation):
        ...
        # # 创建以probs为标准的概率分布
        # action_list = torch.distributions.Categorical(prob_weights)
        # # 依据其概率随机挑选一个动作
