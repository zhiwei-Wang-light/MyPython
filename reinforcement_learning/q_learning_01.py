# -*- coding: utf-8 -*- #
# ------------------------------------------------------------------
# File Name:        q_learning_01.py
# Author:           wzw
# Version:          0.1
# Created:          2025/3/6
# Description:      更新公式:θ=θ+alpha*(r+gamma*max(Q(next_state))-θ)
#                   alpha 更新补偿,gamma 折扣因子
# ------------------------------------------------------------------
import gym
import random
import numpy as np
    ...
    def train(self, epochs):
        for epoch in range(epochs):
            ...
            for i in range(self.num_steps_per_episode):
                ...
                next_s, reward, done,_, info = self.env.step(a)
                if done:
                    break
...
if __name__ == '__main__':
    epochs = 3000
    env = gym.make(
        'CliffWalking-v0')  # 生成实验环境，这里选取悬崖寻路环境CliffWalking-v0，可供选取的环境还包括FrozenLake-v0，Roulette-v0，FrozenLake8x8-v0，Taxi-v3
    env.reset()  # 重置环境
